  ...
  return (
    <div className='min-h-screen'>
      ...
      <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
        <h2 className="bg-clip-text text-transparent text-center bg-black from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
          E-Health-Nexus <br />
        </h2>
      ...
      <section className='min-h-screen'>
        <div>
          <h2 className="bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-900 dark:from-neutral-900 dark:to-black text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
          ...
          <div className="pt-24">
            <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
              ...
              <div className="w-full md:w-3/5 py-6 text-center">
                <img className="w-full md:w-4/5 z-50" src="pnnnnnnng.jpg" />
              </div>
            </div>
          </div>
          ...
          >
            <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
              <g transform="translate(-1.000000, -14.000000)" fillRule="nonzero">
                <g className="wave" fill="#f8fafc"></g>
              </g>
            </g>
          </svg>
        </>
