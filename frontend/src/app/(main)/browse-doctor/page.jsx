              ...
              <div className="carousel-inner relative overflow-hidden w-full">
                  ...
                  >
                      ...
                      >
                          <div className="container mx-auto">
                              <div className="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                                  <p className="text-black text-2xl my-4">Wherever the art of medicine is loved, there is also a love of humanity</p>
                                  <a
                                      className="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black"
                                      href="#"
                                  >
                  ...
                  >
                      ...
                      >
                          <div className="container mx-auto">
                              <div className="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                                  <p className="text-black text-2xl my-4">
                                      Doctors put a human face on science, and a scientific face on suffering
                                  </p>
                                  <a
                                      className="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black"
                                      href="#"
              ...
              <div className="container mx-auto flex items-center flex-wrap pt-4 pb-12">
                  ...
                  <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                      <a href="#">
                          ...
                          <div className="pt-3 flex items-center justify-between">
                              <p className="">Multivitamin Capsules</p>
                              <svg
                  ...
                  <div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                      <a href="#">
                          ...
                          />
                          <div className="pt-3 flex items-center justify-between">
                              <p className="">Antiseptic Liquid</p>
                              <svg
                                  className="h-6 w-6 fill-current text-gray-500 hover:text-black"
                                  xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 24 24"
